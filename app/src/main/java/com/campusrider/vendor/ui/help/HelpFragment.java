package com.campusrider.vendor.ui.help;
...
import com.campusrider.vendor.Adapter.HelpAdapter;
import com.campusrider.vendor.Model.HelpModel;
import com.campusrider.vendor.R;
import com.campusrider.vendor.databinding.FragmentHelpBinding;
...
public class HelpFragment extends Fragment {
    ...
    private void getQs(Context context) {
        ...
        StringRequest request=new StringRequest(Request.Method.GET, "http://campusriderbd.com/Customer/customer/help.php?cat=vendor", new Response.Listener<String>() {
            @Override
