...
public class User {
    int vendor_id;
    String vendor_name,vendor_password,shop_image,shop_category,area,address,phone;
    int delivery_time,vendor_status;

    String vendor_token;

    public User(int vendor_id, String vendor_name, String vendor_password, String shop_image, String shop_category, String area, String address, String phone, int delivery_time, int vendor_status, String vendor_token) {
